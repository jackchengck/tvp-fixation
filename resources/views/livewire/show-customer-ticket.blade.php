    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="card p-3 col-md-8">
                ...
                <div class="container">
                    <div class="mb-3">
                        <label for="customer_email" class="form-label">{{$business->lang=='zh'?'電郵':'Customer Email'}}
                            <span
                    ...
                    <div class="mb-3">
                        <label for="customer_password"
                               class="form-label">{{$business->lang=='zh'?'密碼':'Customer Password'}}
                            <span
                                style="color: red">*</span></label>
                                ...
                                <div class="d-flex flex-column d-sm-flex flex-sm-row justify-content-between">
                                    <div class="d-flex flex-column justify-content-end">
                                        ...
                                        <div>
                                            ...
                                            <h5 class=""
                                                onclick="showName()">{{$business->lang=='zh'?'會員名稱':'Member Name'}}
                                                : {{$customer->name}}</h5>
                                        </div>
                                        <div class="d-flex flex-column">
                                        <span
                                    ...
                                    <div class="card p-lg-5 mb-2">
                                        <div
                                            ...
                                            <div class="d-flex flex-column pr-sm-5">
                                                ...
                                                <p>{{$business->lang=='zh'?'時間':'Timeslot'}}
                                ...
                                <div class="card p-lg-5 mb-2">
                                    <div
                                        ...
                                        <div class=" d-flex flex-column pr-sm-5  ">
                                            ...
                                            <p>{{$business->lang=='zh'?'到期日':'Expiry Date'}}
