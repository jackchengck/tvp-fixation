...
{{--                </thead>--}}
                ...
                @foreach($bookings as $booking)
                    <thead>
                    <tr>
                        <th colspan="8"><b>{{"Records" ." #" .date("YmdHi", strtotime($booking->created_at))}}
                                {{$booking->id}} </b></th>
                    </tr>
                    <tr>
                        <th>Id</th>
...
{{--                        <th>Booking Date</th>--}}
                    ...
                    <tr>
                        <td>{{$loop->index+1}}</td>
                        <td><p>{{$booking->booking_date}} {{$booking->booking_time}}</p></td>
                        <td><p>{{$booking->order_num}}</p></td>
...
{{--                        <td>$ {{$booking->service->price*($booking->quantity)}}</td>--}}
                    </tr>
                    {{--                    @endforeach--}}
                    </tbody>
                    {{--                                                    <tfoot>--}}
