<?php
    ...
    use App\Http\Requests\FoodOrderItemRequest;
    use Backpack\CRUD\app\Http\Controllers\CrudController;
    use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

    /**
     * Class FoodOrderItemCrudController
     * @package App\Http\Controllers\Admin
     * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
     */
    class FoodOrderItemCrudController extends CrudController
    {
        ...
        {
            CRUD::setValidation(FoodOrderItemRequest::class);

            CRUD::field('business_id');
            CRUD::field('food_order_id');
            CRUD::field('dish_id');
            CRUD::field('quantity');
