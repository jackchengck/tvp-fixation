...
/**
 * Class ChatroomCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ChatroomCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Chatroom::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/chatroom');
        CRUD::setEntityNameStrings('chatroom', 'chatrooms');
    }
