<?php
    ...
    class OrderReceiptEmail extends Mailable
    {
        ...
        public function envelope()
        {
            return new Envelope(
                ...
                subject: 'Order #' . $this->order->order_num . ' Receipt',
            );
        }
        ...
        public function attachments()
        {
            ...
            $pdf = Pdf::loadView(
                'doc_template.pdf.customer_invoice', [
                                                       'title'    => "Order Receipt #" . $this->order->order_num,
                                                       'curUser'  => $this->user,
                                                       'data'     => $this->order,
            ...
            return [
                Attachment::fromData(fn() => $pdf->output(), "Order Receipt #" . $this->order->order_num)
